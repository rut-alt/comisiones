...
st.markdown(
    ...
    <style>
        ...
        /* Encabezados, párrafos, etc. en negro */
        ...
        /* Alertas (success, warning…) en negro */
...
# ----------  OBJETIVOS POR ZONA  -------------------------------------------
objetivos_por_zona = {
    # (antiguas zonas; “ventas” -> “entregas”)
    "ZONA NICOLÁS": {
    ...
    "ZONA FELIX": {
        ...
        "A CORUÑA":    {"entregas":0,"compras":0,"financiaciones":0,"garantias":0},
